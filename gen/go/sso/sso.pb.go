...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\x80\x02\n" +
	"\x04Auth\x12T\n" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\"\x16\x82\xd3\xe4\x93\x02\x10:\x01*\"\v/auth/login\x12X\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/auth/is-admin/{user_id}B\x16Z\x14space_1.sso.v1;ssov1b\x06proto3"
